...
class CommonDictionary(BaseModel):
    ...
    dict_name: Optional[str] = None # added with 20210924
    default_dict: str
    default_dict_customized: Optional[bool] = None # added with 20210924
    custom_dict: Optional[str] = None # removed with 20210924
    use_default_dict: Optional[bool] = None # removed with 20210924
    timestamp: str
